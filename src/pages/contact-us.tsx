...
import Map from "../../libs/components/src/lib/Map/Map";
import Forms from "../../libs/components/src/lib/Forms/Forms";
const NoSSR = dynamic(
  () => import("../../libs/components/src/lib/GalleryGrid/GalleryGrid"),
  { ssr: false }
);
